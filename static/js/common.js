...
window.onload = function () {
    ...
    //加载开局库
    com.getData("/static/js/gambit.all.js",
        function (data) {
...
com.loadImages = function (stype) {
    ...
    //绘制棋盘
    com.bgImg = new Image();
    com.bgImg.src = stype + "/bg.png";

    //提示点
    com.dotImg = new Image();
    com.dotImg.src = stype + "/dot.png";

    //棋子
    for (var i in com.args) {
        com[i] = {};
        com[i].img = new Image();
        com[i].img.src = stype + "/" + com.args[i].img + ".png";
        //com[i].img1.src = "img1/"+stype+"/r_m.png";
    }

    //棋子外框
    com.paneImg = new Image();
    com.paneImg.src = stype + "/r_box.png";

    document.getElementsByTagName("body")[0].style.background = stype + "/bg.jpg";
